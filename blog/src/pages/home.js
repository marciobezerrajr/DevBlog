...
export default function Home() {
    ...
    async function getListPosts(){
        ...
        const res = await api.get('api/posts?populate=cover&sort=createdAt:desc')
    ...
    async function handleFavorite(id){
        const res = await setFavorite(id)
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.main}>
                ...
                <Text style={[styles.title, {  marginTop: favCategory.length > 0 ? 14: 46,}]}>Últimas Novidades</Text>
